...
```{r pupil_plot_cs_cma, echo = TRUE, eval = pkgdown::in_pkgdown()}
# CMA approach
...
```{r ccds_plot_cs_pupil_para, echo = TRUE, eval = pkgdown::in_pkgdown()}
...
```{r pupil_plot_cs_multiplier_overall, echo = TRUE, eval = pkgdown::in_pkgdown()}
...
```{r pupil_plot_cs_cma_2, echo = TRUE, eval = pkgdown::in_pkgdown()}
# CMA approach
results_pupil_cma <- SCoRES::SCB_functional_outcome(
                                          data_df = pupil,
                                          object = fosr_mod, 
