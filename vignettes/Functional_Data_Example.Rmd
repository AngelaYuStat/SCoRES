...
- \( Y_(t) \) is a functional outcome (percent_change)
...
The following plots show the results of multiplier bootstrap. The first one displays the SCB for mean outcome function for the use group, while the second one is for the coefficient function of the use group. All possible NA's are inputted using `refund::fpca.face()`.
